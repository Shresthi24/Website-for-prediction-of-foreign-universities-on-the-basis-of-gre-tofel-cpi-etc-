...
class formdemo extends Component {
 ...
 onChange = (e) => {
  ...
  onSubmit = (e) => {
    e.preventDefault();
const { TOFEL,CPI,spl,quant,verbal,awa,college,undergrad,maxcpi} = this.state;


axios.post('/api/index/demo', { TOFEL,CPI,spl,quant,verbal,awa,college,undergrad,maxcpi})
      .then((result) => {
        this.props.history.push("/collegedemo")
      });
        ...
        <FormGroup controlId="formBasicText">               
          ...
          <FormControl id="asd" type="text" name="awa" value={this.state.awa} placeholder="" onChange={this.onChange} step="0.01" >
           ...
           <FormGroup controlId="formBasicText">
                  ...
                  <FormGroup controlId="formBasicText">
          <Col componentClass={ControlLabel} sm={3}>Max Cpi of your batch</Col>
         <Col sm={4}>
          <FormControl type="text"  name="maxcpi" value={this.state.maxcpi} placeholder="" onChange={this.onChange} step="0.01" />
          </Col >
